...
public class PostServiceHandler
{
    ...
    public void doPutRequest(String serverUrl, Map<String, String> params, ResponseCallback callback)
    {
    ...
    private void post(final String requestMethod, String endpoint, Map<String, String> params, ResponseCallback callback)
            throws IOException
    {
        ...
        try
        {
            ...
            conn.setRequestProperty ("API-KEY", "gcok0cw0gc4gg0480csgoowkoc0s8g040g4kk8kg");
